...
router.get('/services', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database_1.db.all('SELECT * FROM services')];
            case 1:
                services = _a.sent();
                res.json(services);
                return [2 /*return*/];
...
router.post('/services', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, url, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, url = _a.url, token = _a.token;
                if (!name || !url || !token) {
                    return [2 /*return*/, res.status(400).json({ error: 'Name, url and token are required' })];
                }
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                if (!id) {
                    return [2 /*return*/, res.status(4.0).json({ error: 'Id is required' })];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, database_1.db.run('DELETE FROM services WHERE id = ?', id)];
            case 2:
                _a.sent();
